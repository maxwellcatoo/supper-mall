...
<script>
  ...
  export default {
    ...
    computed: {
        ...
        if(this.categoryData[this.currentIndex].subcategories) {
          return this.categoryData[this.currentIndex].subcategories
        }
      },
      showCategoryDetail() {
        if (this.currentIndex === -1) return []
        if(this.categoryData[this.currentIndex].categoryDetail[this.currentType].data){
    ...
    methods: {
      ...
      tabClick(index) {
        this.currentType = this.typeArray[index]
        this._getCategoryDetail(this.currentType)
      }
    }
	}
